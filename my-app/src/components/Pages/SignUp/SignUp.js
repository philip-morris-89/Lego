            ...
            <main>
              ...
              <form action="http://localhost:3001/signup" onSubmit={addNewUser}>
                ...
                <div className="text-wrapper">
                  <p>
                    Quando si accettano i Termini e le condizioni, si acconsente
                    anche all’utilizzo delle proprie informazioni personali per
                    l’elaborazione e la gestione del LEGO® Account. Per sapere
                    come controlliamo i tuoi dati personali, leggi la nostra

            ...
            <div className="gridmain">
              ...
              <main>
                <div className="avatar-wrapper">
                  <img
                    src="https://identity.lego.com/assets/images/parentAtDeskWithComputer@4x-44768ff9f5c861e8f17500ea00afea18.png"
                ...
                <form action="http://localhost:3001/signup" onSubmit={addNewUser} >
                  ...
                  <div className="text-wrapper">
                    <p>
                      Quando si accettano i Termini e le condizioni, si
                      acconsente anche all’utilizzo delle proprie informazioni
                      personali per l’elaborazione e la gestione del LEGO®
                      Account. Per sapere come controlliamo i tuoi dati
                      personali, leggi la nostra informativa sulla privacy
                    </p>
                  </div>

...
function ButtonCta({
  ...
  return (
    <a href className={"buttonCta"} data-color={COLOR} data-size={SIZE} data-style={THEME} data-shape={SHAPE}>
      {children}
      <svg viewBox="0 0 18 28" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">

...
function Footer() {
  return (
    <footer className="footer" data-skeleton="false">
      <div data-container="large">
        <section className="footer-aside-siteMap">
          <aside className="footer-aside">
            <header className="footer-aside-header">
              <div className="footer-aside-header-item">
                <svg
              ...
              <div className="footer-aside-header-item">
                <button className="footer-button-country">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="17"
                    height="19"
                  ...
                  <div className="footer-aside-header-item-italia">Italia</div>
                </button>
              </div>
            </header>
            <div className="footer-aside-link">
              <a href="./" className="footer-link">
                <span>Cataloghi LEGO</span>
              </a>
              <a href="./" className="footer-link">
                <span>Trova un negozio LEGO</span>
              </a>
            </div>
            <div className="footer-marketing">
              <h6 className="footer-h6">Email marketing title</h6>
              <div className="footer-marketing-email">Input field</div>
            </div>
          </aside>
          <ul className="footer-siteMap-ul">
            <li className="footer-siteMap-li">
              <details open>
                <summary>
                  <h6 className="footer-h6">Chi siamo</h6>
                  <svg
                    className="arrow"
                    viewBox="0 0 18 28"
                    aria-hidden="true"
            ...
            <li className="footer-siteMap-li">
              <details open>
                <summary>
                  <h6 className="footer-h6">Supporto</h6>
                  <svg
                    className="arrow"
                    viewBox="0 0 18 28"
                    aria-hidden="true"
            ...
            <li className="footer-siteMap-li">
              <details open>
                <summary>
                  <h6 className="footer-h6">ATTRAZIONI</h6>
                  <svg
                    className="arrow"
                    viewBox="0 0 18 28"
                    aria-hidden="true"
            ...
            <li className="footer-siteMap-li">
              <details open>
                <summary>
                  <h6 className="footer-h6">ALTRE INFORMAZIONI</h6>
                  <svg
                    className="arrow"
                    viewBox="0 0 18 28"
                    aria-hidden="true"
        ...
        <section className="footer-social-marketing">
          <div className="footer-marketing">
            <h6 className="footer-h6">Accedi</h6>
            <div className="footer-marketing-email"></div>
          </div>
          <div className="footer-social">
            <h6 className="footer-h6">SEGUICI</h6>
            <ul className="footer-social-links">
              <li>
                <a href="./">
                  <img
                    className="footer-social-media-icon"
                    src="https://www.lego.com/_next/static/images/facebook-895fba5a20c4facacb9655dade1d256c.svg"
                    alt=""
                  />
                </a>
              </li>
              <li>
                <a href="./">
                  <img
                    className="footer-social-media-icon"
                    src="https://www.lego.com/_next/static/images/twitter-1e56a60f172faa3c81bfdd93bc099416.svg"
                    alt=""
                  />
                </a>
              </li>
              <li>
                <a href="./">
                  <img
                    className="footer-social-media-icon"
                    src="https://www.lego.com/_next/static/images/instagram-e47f0d4b15ff76083b415be91e96f43b.svg"
                    alt=""
                  />
                </a>
              </li>
              <li>
                <a href="./">
                  <img
                    className="footer-social-media-icon"
                    src="https://www.lego.com/_next/static/images/youtube-c51b2c62583921aae813fdc55df5f9d2.svg"
                    alt=""
                  />
                </a>
              </li>
        ...
        <section className="footer-privacy-copyright">
          ...
          <div className="footer-copyright">
            <p>
              LEGO System A/S, DK-7190 Billund, Denmark. Per effettuare acquisti
              online è necessario essere maggiorenni. LEGO, il logo LEGO, la
              Minifigure, DUPLO, LEGENDS OF CHIMA, NINJAGO, BIONICLE, MINDSTORMS
              e MIXELS sono marchi registrati e copyright di LEGO Group. ©2022
              The LEGO Group. Tutti i diritti riservati. L'uso di questo sito
              implica l'accettazione dei Termini d’uso.
            </p>
          </div>
        </section>
      </div>

      ...
      <div className="navBar-row2">
        <ul className="navBar-row2-col1">
          ...
          <ul className="navBar-row1-col3">
            <li>
              <a href="./" className="navBar-account-vip" onClick={(e) => { e.preventDefault(); setOpenModal(true) }}>
                <svg
                  width="20"
                  height="22"
                  viewBox="0 0 20 22"
        ...
        <div className="navBar-row2">
          ...
          <ul className="navBar-row2-col3">
            ...
            <li>
              <a className="navBar-actionLink" onClick={(e) => { e.preventDefault(); setOpenModal(true); }}>
